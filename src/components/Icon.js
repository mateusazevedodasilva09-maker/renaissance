/**
 * Icônes SVG inline (style « lucide » : trait fin, arrondi, monochrome).
 * Usage : <Icon name="calendar" /> — hérite de la couleur du texte.
 */
...
const PATHS = {
  ...
  run: (
    <>
      ...
      <path d="M13.5 8.5 10 11l2 3-3.5 6M13.5 8.5 17 10l3.5-1M13.5 8.5l-4-1L6 10M12 14l3 2 1 5" />
    </>
  ),
};
