/**
 * Espace coach : shell dédié et ÉPURÉ. Le coach n'a QUE ses sections (Mes
 * coachés, Qui a besoin de moi, Mon planning, Mes tâches) via CoachNav — jamais
 * le menu d'administration ni la prospection. Un ADMIN qui observe un coach
 * dispose en plus d'un retour vers l'admin.
 */
